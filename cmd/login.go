...
var loginCmd = &cobra.Command{
	Use:   "login",
	Short: "Authenticate with SeqToID",
	Long: `Log into SeqToID so you can upload samples.
...
comprimised, please reach out to SeqToID support
at https://chanzuckerberg.zendesk.com/hc/en-us/requests/new.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err != nil {
			...
			fmt.Print("Thanks for logging in! Just a friendly reminder: To not overwhelm SeqToID, please limit your uploads to less than 500 samples per upload, and not more than 1,000 samples per week.\n")
		}
